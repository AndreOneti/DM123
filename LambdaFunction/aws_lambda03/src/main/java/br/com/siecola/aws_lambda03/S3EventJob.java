...
public class S3EventJob implements RequestHandler<S3Event, String> {
    ...
    private void saveInvoice(Invoice invoice) {
        ...
        ddbClient.withRegion(RegionUtils.getRegion("us-east-1"));
        DynamoDB dynamoDB = new DynamoDB(ddbClient);
        Table table = dynamoDB.getTable("aloc-invoice-lambda");
    ...
    private String downloadObject(String bucketName, String objectKey) throws IOException {
        ...
        amazonS3Client.withRegion(RegionUtils.getRegion("us-east-1"));
